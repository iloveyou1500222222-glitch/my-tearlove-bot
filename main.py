...
async def track_members(u: Update, c: ContextTypes.DEFAULT_TYPE):
    ...
    if u.chat_member.new_chat_members:
        ...
        msg = f"✨ မင်္ဂလာပါ {user.first_name} ရေ... ကြိုဆိုပါတယ်ရှင့်ထည့်ခဲ့ပ တီမှာအကုန်ရတယ်မရတာ‌ေတွ။ 🥰"
        ...
        await chat.send_message(f"🥀 {user.first_name} ရေ... ထွက်သွားတော့မလား... မင်းမရှိတဲ့ ဒီနေရာလေးက အထီးကျန်နေခဲ့ပြီနော်  အချိန်တန်ရင်ပြန်လာခဲ့ပဟာ😓။ 🕯️")
